...
function btnCloneAlumnosClick() {
    ...
    if (ids.length == 0) {
        ...
        buttons[Globalize.formatMessage('TextYes')] = function () {
            ...
            popup.block();
            $.ajax({
                url: appData.siteUrl + 'api/v1/alumnos/clone',
				type: 'POST',
                data: $.toJSON({
                    Ids: ids
                }),
                success: function () {
                    popup.unblock();
					popup.dialog('close');
					showMessage(Globalize.formatMessage("MessageCloningOK"), true);
        ...
        showCustomMessage({
            message: Globalize.formatMessage('MessageConfirmCloneEntries'),
            buttons: buttons
        });
    }
}

function popupCloneAlumnos(id) {
    var buttons = new Object();
    var popup = null;
    ...
    showCustomMessage({
        message: Globalize.formatMessage('MessageConfirmCloneEntry'),
        buttons: buttons,
        open: function () {
            popup = $(this);
        }
